...
// {
//   auto token = Token(t, v, source_file_.getLineNum(),
//   source_file_.getColNum()); tokens_.push_back(token);
// }
...
//   {
//     std::cout << "value: " << elem.value << ", at line: " << elem.line_num
//               << ", at col: " << elem.col_num << '\n'
//               << std::endl;
//   }
// }